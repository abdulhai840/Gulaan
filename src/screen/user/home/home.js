...
class home extends Component {
  ...
  handleRenderStateChangeTailor() {
    this.setState({ tailor: true, trending: false, latest: false });
  }
  handleRenderStateChangeTrending() {
    this.setState({ tailor: false, trending: true, latest: false });

  }
  handleRenderStateChangeLatest() {
    this.setState({ tailor: false, trending: false, latest: true });
        ...
        <View style={styles.innerView}>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => this.handleRenderStateChangeLatest()}
            >

              <View style={{ width: 100, height: 50, marginLeft: 10, alignItems: 'center', borderBottomWidth: this.state.latest ? 0.5 : 0 }}
              >
                <Text style={{ fontSize: 26, color: this.state.latest ? 'green' : 'black' }}>Latest</Text>
              </View>
            </TouchableOpacity>
            ...
            <>
              <View
                ...
                <View style={{ width: "95%", justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
                  {ScrappedData.map((x) =>
                    <View>
                      <Image source={x.image} style={{ height: 100, width: 100, marginLeft: 5, resizeMode: 'stretch', }} />
                    </View>
                  )}
